...
class CalendarVideoListAlert extends StatefulWidget {
  const CalendarVideoListAlert(
      {super.key, this.publishVideoList, this.getVideoList});

  final List<VideoModel>? publishVideoList;
  final List<VideoModel>? getVideoList;

  @override
  State<CalendarVideoListAlert> createState() => _CalendarVideoListAlertState();
}

class _CalendarVideoListAlertState extends State<CalendarVideoListAlert> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            Expanded(child: displayCalendarVideoList()),
          ],
        ),
      ),
    );
  ...
  ///
  Widget displayCalendarVideoList() {
    final List<Widget> list = <Widget>[];

    widget.publishVideoList?.forEach((VideoModel element) {
    ...
    widget.getVideoList?.forEach((VideoModel element) {
      list.add(GestureDetector(
        onLongPress: () {
          YoutubeDialog(
            context: context,
